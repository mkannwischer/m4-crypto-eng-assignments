...
#define G(r0,r1,r2,r3,r4,r5,r6,r7,i) \
  F(r0,r1,r2,r3,r4,r5,r6,r7,w0 ,roundc[i + 0]) \
  F(r7,r0,r1,r2,r3,r4,r5,r6,w1 ,roundc[i + 1]) \
  F(r6,r7,r0,r1,r2,r3,r4,r5,w2 ,roundc[i + 2]) \
  F(r5,r6,r7,r0,r1,r2,r3,r4,w3 ,roundc[i + 3]) \
  F(r4,r5,r6,r7,r0,r1,r2,r3,w4 ,roundc[i + 4]) \
  F(r3,r4,r5,r6,r7,r0,r1,r2,w5 ,roundc[i + 5]) \
  F(r2,r3,r4,r5,r6,r7,r0,r1,w6 ,roundc[i + 6]) \
  F(r1,r2,r3,r4,r5,r6,r7,r0,w7 ,roundc[i + 7]) \
  F(r0,r1,r2,r3,r4,r5,r6,r7,w8 ,roundc[i + 8]) \
  F(r7,r0,r1,r2,r3,r4,r5,r6,w9 ,roundc[i + 9]) \
  F(r6,r7,r0,r1,r2,r3,r4,r5,w10,roundc[i + 10]) \
  F(r5,r6,r7,r0,r1,r2,r3,r4,w11,roundc[i + 11]) \
  F(r4,r5,r6,r7,r0,r1,r2,r3,w12,roundc[i + 12]) \
  F(r3,r4,r5,r6,r7,r0,r1,r2,w13,roundc[i + 13]) \
  F(r2,r3,r4,r5,r6,r7,r0,r1,w14,roundc[i + 14]) \
  F(r1,r2,r3,r4,r5,r6,r7,r0,w15,roundc[i + 15])

static const uint32 roundc[64] = {
  0x428a2f98
, 0x71374491
, 0xb5c0fbcf
, 0xe9b5dba5
...
static int crypto_hashblocks(unsigned char *statebytes,const unsigned char *in,unsigned long long inlen)
{
  uint32 state[8];
  uint32 r0;
  uint32 r1;
